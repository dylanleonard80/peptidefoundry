...
export const pt141BlendData = {
  ...
  aboutParagraphs: [
    "PT-141 originated from Melanotan II research at the University of Arizona in the 1980s. Scientists studying melanocortin receptor analogs observed unexpected MC4R-mediated signaling activity distinct from the melanogenesis pathways they were originally investigating. This led to a separate line of research into melanocortin-4 receptor function.",
    "The researchers isolated the structural elements of Melanotan II responsible for this MC4R activity and modified them to create PT-141, also called Bremelanotide. Its mechanism of action involves central melanocortin receptor signaling rather than peripheral vascular pathways, making it of interest for studying CNS melanocortin systems.",
  ...
  howItWorksIntro: "This blend combines three peptides targeting complementary melanocortin and neuroendocrine signaling pathways: PT-141 activates MC4R in neuronal models, Kisspeptin engages GnRH-related signaling cascades, and Pinealon has been studied for interactions with circadian regulatory mechanisms. Together they enable multi-pathway research into melanocortin and hypothalamic-pituitary signaling.",
  howItWorksAccordions: [
